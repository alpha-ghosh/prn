 ...
 */
class CRM_PRNCivirules_Upgrader_Base {

  /**
   * @var CRM_PRNCivirules_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_PRNCivirules_Upgrader(
        'org.prn.civirules',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_PRNCivirules_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_PRNCivirules_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
